...
const CommandButton = () => {
  return (
    <a href="src\CV\Ahmed-Elsayed.pdf" download={'Ahmed-Elsayed.pdf'} className="button">
      <svg
        stroke="#ffffff"
        xmlSpace="preserve"
        viewBox="0 0 80 80"
